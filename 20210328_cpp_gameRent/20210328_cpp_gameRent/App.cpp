...
App::App() {
    ...
    mFileRW = new FileRW();
    mRentalSystem = new RentalSystem();
...
App::~App() {
    ...
    if (mRentalSystem != nullptr) {
        delete mRentalSystem;
        mRentalSystem = nullptr;
    }
    if (mCustomerManager != nullptr) {
        delete mCustomerManager;
        mCustomerManager = nullptr;
    }
